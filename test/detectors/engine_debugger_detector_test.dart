...
void main() {
  group('EngineDebuggerDetector', () {
    late EngineDebuggerDetector detector;
    late EngineDebuggerDetector disabledDetector;

    setUp(() {
      detector = EngineDebuggerDetector();
      disabledDetector = EngineDebuggerDetector(enabled: false);
    });
    ...
    group('Constructor and Properties', () {
      ...
      test('should create detector with specified enabled state', () {
        final enabledDetector = EngineDebuggerDetector(enabled: true);
        final disabledDetector = EngineDebuggerDetector(enabled: false);
      ...
      test('should have correct detector name', () {
        expect(detector.detectorName, equals('DebuggerDetector'));
      });
    ...
    group('performCheck', () {
      test('should return secure result when detector is disabled', () async {
        ...
        expect(result.details, equals('Debugger detector disabled'));
      ...
      test('should handle secure state with proper confidence', () async {
        ...
        if (result.isSecure) {
          expect(result.details, contains('No debugger detected'));
          expect(result.detectionMethod, equals('debugger_checks'));
