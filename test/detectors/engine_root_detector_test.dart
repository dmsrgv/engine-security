  ...
  group('EngineRootDetector', () {
    ...
    group('Constructor and Properties', () {
      ...
      test('should have correct threat type', () {
        expect(detector.threatType, equals(SecurityThreatType.rootJailbreak));
      });
    ...
    group('Detector Info', () {
      test('should return correct detector info when enabled', () {
        ...
        expect(info.threatType, equals(SecurityThreatType.rootJailbreak));
    ...
    group('performCheck', () {
      ...
      test('should detect threat with proper details', () async {
        ...
        if (!result.isSecure) {
          expect(result.threatType, equals(SecurityThreatType.rootJailbreak));
